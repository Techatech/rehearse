-- Seed test users
INSERT OR IGNORE INTO users (workos_id, email, name, subscription_tier)
VALUES
    ('test_user_001', 'test1@example.com', 'Test User 1', 'basic'),
    ('test_user_002', 'test2@example.com', 'Test User 2', 'pro'),
    ('test_user_003', 'test3@example.com', 'Test User 3', 'enterprise');
